...
const cli = (exports.cli = yargs
    ...
    .example('rcutil printenv my-project --screaming', 'Print all variable names and values of my-project in typical SCREAMING_SNAKE_CASE env format.')
    .example('rcutil printenv my-project --project=bar', 'Print all variable names and values of my-project in env format from the project bar.')
    .parserConfiguration({
